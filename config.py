...
def get_aws_account_id():
    ...
    try:
        ...
        # Fallback for development/testing when AWS credentials aren't available
        return "123456789012"
...
FRAMEWORK_MODEL_COMBINATIONS = [
    {
        "frameworks": ["raw_openai_api", "pydantic_ai_openai"],
        "models": [
    ...
    {
        "frameworks": ["pydantic_ai", "pydantic_ai_enhanced"],
        "models": [
            # AWS Bedrock models
